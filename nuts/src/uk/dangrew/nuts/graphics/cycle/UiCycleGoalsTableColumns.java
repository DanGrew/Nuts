...
public class UiCycleGoalsTableColumns implements ConceptTableColumnsPopulator< DerivedGoal > {
   ...
   @Override public void populateColumns( ConceptTable< DerivedGoal > table ) {
