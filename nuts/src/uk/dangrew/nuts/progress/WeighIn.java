 ...
 */
public class WeighIn implements WeightRecording {
    ...
    * @param date the {@link LocalDate} of the {@link WeighIn}.
    * @param dayTime the {@link DayTime} of the {@link WeighIn}.
    */
   public WeighIn( LocalDate date, DayTime dayTime ) {
      this( date, dayTime, null, null, null );
   }//End Constructor
    ...
    */
   public WeighIn( LocalDate date, DayTime dayTime, Double weight, Double bodyFat, Double leanMass ) {
      this.date = date;
    ...
    * {@inheritDoc}
    */
   @Override public LocalDate date() {
      return date;
   }//End Method
