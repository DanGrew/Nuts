...
public class SimpleGoalRatioCalculatorTest {

   private CalorieGoal calorieGoal;
   private Nutrition nutrition;
   private GoalAnalytics analytics;
   private SimpleGoalRatioCalculator systemUnderTest;
   ...
   @Before public void initialiseSystemUnderTest() {
      ...
      systemUnderTest = new SimpleGoalRatioCalculator( calorieGoal, analytics, nutrition );
   }//End Method
   ...
   private void assertMacroProportions( double c, double f, double p ) {
      systemUnderTest.calculate( NutritionalUnit.Carbohydrate );
      assertThat( analytics.of( NutritionalUnit.Carbohydrate ).get(), is( c ) );
      systemUnderTest.calculate( NutritionalUnit.Fat );
      assertThat( analytics.of( NutritionalUnit.Fat ).get(), is( f ) );
      systemUnderTest.calculate( NutritionalUnit.Protein );
   ...
   @Test public void shouldCalculateCalorieRatio(){
      ...
      systemUnderTest.calculate( NutritionalUnit.Calories );
