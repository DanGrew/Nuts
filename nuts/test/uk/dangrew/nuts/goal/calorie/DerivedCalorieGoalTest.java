...
public class DerivedCalorieGoalTest {
   ...
   @Test public void shouldProvideMacrosWhenCaloriesChange(){
      ...
      assertThat( systemUnderTest.properties().nutrition().of( NutritionalUnit.Fat ).get(), is( closeTo( 68.95, TestCommon.precision() ) ) );
      assertThat( systemUnderTest.properties().nutrition().of( NutritionalUnit.Protein ).get(), is( closeTo( 197.0, TestCommon.precision() ) ) );
