...
public class MealPropertiesCalculatorTest {
   ...
   @Test public void shouldCalculatePropertiesOnChange(){
      ...
      assertThat( meal.foodAnalytics().of( NutritionalUnit.Carbohydrate ).get(), is( 0.0 ) );
      assertThat( meal.foodAnalytics().of( NutritionalUnit.Fat ).get(), is( 0.0 ) );
      assertThat( meal.foodAnalytics().of( NutritionalUnit.Protein ).get(), is( 0.0 ) );
      assertThat( meal.foodAnalytics().of( NutritionalUnit.Fibre ).get(), is( 0.0 ) );
   }//End Method
   ...
   @Test public void shouldResetPropertiesWhenEmptyMeal(){
      ...
      assertThat( meal.foodAnalytics().of( NutritionalUnit.Carbohydrate ).get(), is( 48.8 ) );
      assertThat( meal.foodAnalytics().of( NutritionalUnit.Fat ).get(), is( 11.2 ) );
      assertThat( meal.foodAnalytics().of( NutritionalUnit.Protein ).get(), is( 40.0 ) );
      assertThat( meal.foodAnalytics().of( NutritionalUnit.Fibre ).get(), is( 4.48 ) );
   }//End Method
